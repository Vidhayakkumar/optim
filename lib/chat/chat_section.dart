        ...
        appBar: AppBar(
          ...
          title: const Column(
            children: [
              ...
              Text('Kavita', style: TextStyle(color: Color(0xff2354C5), fontSize: 13)),
            ],
          ),
          leadingWidth: 90,
          leading: Row(
                          ...
                          return Align(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  isMe
                                      ? CircleAvatar(backgroundImage: MemoryImage(bytes), radius: 17)
                                      : CircleAvatar(backgroundImage: MemoryImage(widget.image), radius: 17),
                                  Padding(
