             ...
             children: [
              Stack(
                ...
                children: [
                  ...
                  SvgPicture.asset("assets/images/Vector.svg",height: mq.height * 0.2),
                  Positioned(
                    top: 10,
                    right: 20,
                  ...
                  Positioned(
                    left: mq.width * 0.03,
                    top: mq.height * 0.17,
                    child: const Text("An Ideal Platform To",
                      style: TextStyle(
                        fontSize: 20,
              ...
              Text("  Grow Your Business",
                style: TextStyle(
                    fontSize: 20,
                    color: Color.fromRGBO(2, 125, 195, 1)
                ),),
              ...
              Column(
                ...
                children: [
                  Image.asset("assets/images/onfirst.png",),
                  const Text("   Elevate Your Sale Game,",
                    style: TextStyle(
  ...
  return RichText(
      text: TextSpan(
        children: [
          ...
          TextSpan(
            text: "SALES OPTIM",style:
              TextStyle(
                fontSize: 17,
                color: Color.fromRGBO(13, 80, 175, 1.0)
              )
          ),
          TextSpan(
